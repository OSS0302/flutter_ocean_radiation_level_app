...
Future<void> saveJsonData(String jsonData) async {
  ...
  Future<http.Response> saveJsonDatagetOceanRaditionLevelListings( {String certKey = certKey, required String startDate, required String endDate}) async {
    return await client.get(Uri.parse(
        'http://www.nfqs.go.kr/hpmg/front/api/smp_ra_api.do?'
            'cert_key=$certKey&start_dt=$startDate&end_dt=$endDate'
    ));
  }
}
